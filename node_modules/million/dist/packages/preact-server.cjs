...
const utils = require('../shared/million.f841e618.cjs');
...
const block = (Component) => {
  ...
  function MillionBlockLoader(props) {
    ...
    if (!blockFactory) {
      return preact.h(utils.RENDER_SCOPE, null, preact.h(Component, props));
    }
...
function For(props) {
  ...
  return preact.h(utils.RENDER_SCOPE, null, ...props.each.map(props.children));
}
